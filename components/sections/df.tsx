...
import { BriefcaseIcon, ArrowUpRight, Building2 } from "lucide-react";
    ...
    <section id="experience" className="py-24 px-4 md:px-6 bg-gradient-to-b from-background to-background/50">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="relative">
          ...
          <div className="absolute left-4 md:left-8 top-12 h-[calc(100%-6rem)] w-1 bg-border/40 rounded-full z-0"></div>
              ...
              >
                <div className="relative pl-12 md:pl-16">
                  ...
                  <div className="absolute left-4 md:left-8 top-12 z-10 -translate-x-1/2">
                    <div className="h-5 w-5 rounded-full bg-background border-4 border-primary/70 group-hover:border-primary group-hover:scale-110 transition-all duration-300"></div>
                  </div>
                  ...
                  <div className="relative bg-card hover:bg-card/80 border border-border/40 hover:border-primary/30 rounded-xl overflow-hidden transition-all duration-300 shadow-sm hover:shadow-md">
                    ...
                    {/* Content */}
                    <div className="grid grid-cols-1 md:grid-cols-12 p-6 md:p-8 gap-6 pt-8">
                      {/* Left Column - Company */}
